...
public class Timer_TreeSet_Permuted extends TimerTemplate {
     ...
     */
    public Timer_TreeSet_Permuted(int[] problemSizes, int timesToLoop) {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "treeset_add_timing_results_permuted.csv";
