...
public class HashPerformanceTimingCONTAINS extends TimerTemplate {
    // Instance to be tested
    private ChainingHashTable table;
    // List of string values to be tested for "contains" performance
    private List<String> data;
    private HashFunctor functor;

    public HashPerformanceTimingCONTAINS(int[] problemSizes, int timesToLoop, HashFunctor functor) {
        super(problemSizes, timesToLoop);
        this.functor = functor;
    }

    @Override
    // Prepare environment for timing test with problem size n
    protected void setup(int n) {
        ...
        // Initialize data list to hold strings to be inserted and tested
        data = new ArrayList<>();
    ...
    @Override
    // Time the "contains" method for the hash table
    protected void timingIteration(int n) {
        for (String s : data) {
            table.contains(s); // Measure the time it takes to check containment
        }
    }
    ...
    public static void main(String[] args) {
        ...
        int timesToLoop = 10;
        String outputFileName = "hash_performance_results_CONTAINS.csv";
        ...
        for (HashFunctor functor : List.of(new BadHashFunctor(), new MediocreHashFunctor(), new GoodHashFunctor())) {
            ...
            HashPerformanceTimingCONTAINS timing = new HashPerformanceTimingCONTAINS(problemSizes, timesToLoop, functor);
