...
public class Timer_Heap_Sorted extends TimerTemplate {
     ...
     */
    public Timer_Heap_Sorted(int[] problemSizes, int timesToLoop) {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "heap_add_timing_results_sorted.csv";
